...
# train the classifier and get its predictions
theta, theta_0 = p1.pegasos(train_bow_features, train_labels, 25, 0.0100)
test_classifications = p1.classify(test_bow_features, theta, theta_0)

test_accuracy = p1.accuracy(test_classifications, test_labels)
print('Test accuracy with Pegasos:', test_accuracy)
