...
# for lambda_factor in [0.01, 0.1, 1]:
#     print('Linear Regression test_error =', run_linear_regression_on_MNIST(lambda_factor=lambda_factor))
...
# for temp_parameter in tqdm([.5, 1.0, 2.0]):
#     print('softmax test_error=', run_softmax_on_MNIST(temp_parameter))
...
# print('softmax (trained on train_y_mod3) test_error_mod3=', run_softmax_on_MNIST_mod3(temp_parameter=1))
...
def run_softmax_on_PCA(temp_parameter=1):
...
# print('softmax_on_PCA test_error=', run_softmax_on_PCA(temp_parameter=1))
...
print('softmax_pca10 test_error=', test_error)
